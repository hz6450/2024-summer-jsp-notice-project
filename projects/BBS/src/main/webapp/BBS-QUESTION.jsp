...
<body>
    ...
    <div class="container mt-4">
        ...
        <button type="button" class="btn btn-light " onclick="location.href='BBS.jsp'">전체</button>
            ...
            <button type="button" class="btn btn-light active" onclick="location.href='BBS-QUESTION.jsp'">질문</button>
            <button type="button" class="btn btn-light " onclick="location.href='BBS-FREE.jsp'">자유</button>
        </div>
        ...
        <div class="row">
            <table class="table table-striped" id="bbs-table">
                ...
                <tbody>
                    ...
                    ArrayList<Bbs> list = bbsDAO.getListQuestion(pageNumber);
